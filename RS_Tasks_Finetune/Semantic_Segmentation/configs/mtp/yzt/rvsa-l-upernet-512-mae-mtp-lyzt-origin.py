...
#         data_root=data_root,
#         data_prefix=dict(
#             img_path='splitFile_raster\\train', seg_map_path='splitFile_origin\\train'),
...
#             img_path='splitFile_raster\\test', seg_map_path='splitFile_origin\\test'),
...
#         type=dataset_type,
#         data_root=data_root,
#         data_prefix=dict(img_path='splitFile_raster\\test', seg_map_path='splitFile_origin\\test'),
...
#         loss_decode=dict(
#             type='CrossEntropyLoss', use_sigmoid=False, loss_weight=1.0, class_weight=[1.83134748,0.56143391,20.53331697,0,18.79333275,3.42862783,0.23368707], reduction='mean')
#     ),
#     train_cfg=dict(),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(
            img_path='splitFile_raster\\val', seg_map_path='splitFile_origin\\val'),
        pipeline=val_pipeline))
test_dataloader = dict(
    batch_size=1,
    num_workers=1,
...
model = dict(
    ...
    decode_head=dict(
        ...
        align_corners=False,
        loss_decode=dict(
            type='CrossEntropyLoss', use_sigmoid=False, loss_weight=1.0, class_weight= [1.67813263,  0.51446303, 18.81545118,0, 17.22103815,  3.14178073,  0.21413626])
    ),
    train_cfg=dict(),
    test_cfg=dict(mode='slide', stride=(384,384), crop_size=(512, 512)))